...
void ToolLine::OnMousePressed(QPoint point) { m_start = point; }
void ToolLine::OnMouseMove(QRect /* area */, QPoint point)
{
...
void ToolLine::OnMouseReleased(QPoint /* point */) {}

void ToolLine::OnKeyPressed(QString /* c */) {}

QVector<QRect> ToolLine::MarkedAreas() { return QVector<QRect>(); }
