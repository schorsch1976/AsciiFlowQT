...
void ToolArrow::OnMousePressed(Point point) { m_start = point; }
void ToolArrow::OnMouseMove(Rect /* area */, Point point)
{
...
void ToolArrow::OnMouseReleased(Point /* point */) {}

void ToolArrow::OnKeyPressed(KeyEvent /* c */) {}

std::vector<Rect> ToolArrow::MarkedAreas() { return std::vector<Rect>{}; }
} // namespace Common
