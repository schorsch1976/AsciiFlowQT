...
void ToolLine::OnMousePressed(Point point) { m_start = point; }
void ToolLine::OnMouseMove(Rect /* area */, Point point)
{
...
void ToolLine::OnMouseReleased(Point /* point */) {}

void ToolLine::OnKeyPressed(KeyEvent /* c */) {}

std::vector<Rect> ToolLine::MarkedAreas() { return std::vector<Rect>{}; }
} // namespace Common